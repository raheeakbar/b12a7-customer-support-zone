		...
		>
			...
			<div className="card-meta flex justify-between align-center">
				...
				<div className="card-meta-group flex align-center gap-md">
					<span className="card-username">{ticket.customer}</span>
			...
			{pendingTickets.length === 0 ? (
				...
				<div className="flex flex--dir-col gap-rg">
					{pendingTickets
						...
						.reverse()
						.map((ticket) => (
							<div key={ticket.id} className="flex flex--dir-col gap-rg card">
								<h3 className="tertiary-heading">{ticket.title}</h3>
								<button
			...
			{resolvedTickets.length === 0 ? (
				...
				<div className="flex flex--dir-col gap-rg">
					{resolvedTickets
						...
						.reverse()
						.map((ticket) => (
							<div key={ticket.id} className="bg-blue resolved">
								<h3 className="tertiary-heading">{ticket.title}</h3>
							</div>
						))}
				</div>
